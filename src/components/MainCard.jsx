    ...
    return (
        <>
            <div className="rounded-lg bg-white my-4 flex flex-col">
                <span className="text-dark-brown font-bold px-2 py-4">Spending - Last 7 days</span>
                ...
                <div className="flex pt-2 pb-6 px-4 justify-between">
                    <div className="flex flex-col">
                        ...
                        <p className="font-bold text-dark-brown text-2xl">$478.33</p>
                    </div>
                    <div className="flex flex-col">
                        <p className="font-bold text-dark-brown text-right pt-2">+2.4%</p>
